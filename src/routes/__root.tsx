...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OtoParça — Yedek Parça Yönetim Sistemi" },
      { name: "description", content: "Stok, satış, müşteri ve tedarikçi yönetimi için modern oto yedek parça yönetim sistemi." },
    ],
    links: [
